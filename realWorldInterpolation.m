...
function a = ScreenvBattery()
    ...
    y = w(:,5); % battery drain
    % eval_space = linspace(min(x), max(x));
    ...
    x1 = w1(:,4);
    y1 = w1(:,5);
    % eval_space1 = linspace(min(x1), max(x1));
    ...
    x2 = w2(:,4);
    y2 = w2(:,5);
    % eval_space2 = linspace(min(x2), max(x2));
    ...
    x3 = w3(:,4);
    y3 = w3(:,5);
    % eval_space3 = linspace(min(x3), max(x3));
    ...
    x4 = w4(:,4);
    y4 = w4(:,5);
    % eval_space4 = linspace(min(x4), max(x4));
